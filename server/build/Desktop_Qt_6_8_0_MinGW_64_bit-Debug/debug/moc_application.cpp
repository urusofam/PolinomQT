...
struct qt_meta_stringdata_CLASSTApplicationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTApplicationENDCLASS = QtMocHelpers::stringData(
    "TApplication",
    "recieve",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTApplicationENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTApplicationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTApplicationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTApplicationENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTApplicationENDCLASS.stringdata0))
